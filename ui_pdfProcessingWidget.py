...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.fileNameLineEdit.setPlaceholderText(QCoreApplication.translate("Form", u"Enter file name", None))
        ...
        self.docTypeDropdownBox.setItemText(3, QCoreApplication.translate("Form", u"Lab Invoice", None))
        self.docTypeDropdownBox.setItemText(4, QCoreApplication.translate("Form", u"OrthoK", None))
        self.docTypeDropdownBox.setItemText(5, QCoreApplication.translate("Form", u"Outside Rx", None))
        self.docTypeDropdownBox.setItemText(6, QCoreApplication.translate("Form", u"POF Waiver", None))
        self.docTypeDropdownBox.setItemText(7, QCoreApplication.translate("Form", u"Rx Request", None))
